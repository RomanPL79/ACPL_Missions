...
_rando_e				= 	21;		;//Im bli¿ej jedynki tym skill bêdzie losowany bli¿ej górnej granicy. 
							//Im bli¿ej trójki - skill bêdzie losowany bli¿ej dolnego zakresu. 
							//2 to ustawienie zbalansowane, w którym bardzo dobrze i bardzo Ÿle wyszkolony wróg wystêpuje najrzadziej. 

msc_skill_accuracy_min_e		=	0.1		;//Celnoœæ
msc_skill_accuracy_max_e		=	0.16		;
...
msc_skill_courage_min_e		=	0.15	;//Odwaga - im wiêcej tej wartoœci tym trudniej przycisn¹æ wroga
msc_skill_courage_max_e		=	0.3		;
...
_rando_r				= 	5;		;//Im bli¿ej jedynki tym skill bêdzie losowany bli¿ej górnej granicy. 
							//Im bli¿ej trójki - skill bêdzie losowany bli¿ej dolnego zakresu. 
							//2 to ustawienie zbalansowane, w którym bardzo dobrze i bardzo Ÿle wyszkolony wróg wystêpuje najrzadziej. 

msc_skill_accuracy_min_r		=	0.1		;//Celnoœæ
msc_skill_accuracy_max_r		=	0.15		;

msc_skill_shake_min_r		=	0.1		;//Stabilnoœæ rêki w czasie strzelania
msc_skill_shake_max_r		=	0.15		;

msc_skill_speed_min_r		=	0.1		;//Prêdkoœæ celowania
msc_skill_speed_max_r		=	0.15		;

msc_skill_spot_min_r		=	0.2		;//Dystans wykrywania
msc_skill_spot_max_r		=	0.4		;

msc_skill_time_min_r		=	0.3		;//Czas wykrywania
msc_skill_time_max_r		=	0.5		;

msc_skill_general_min_r		=	0.2		;//Skill generalny - u¿ywanie os³on, flankowanie, generalny brain-factor
msc_skill_general_max_r		=	0.5		;
