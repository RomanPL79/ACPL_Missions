						...
						if (_ammo in (getArtilleryAmmo [_vh])) then
						{
							...
							if (_pos inRangeOfArtillery [[_vh],_ammo]) then
							{
								...
								{																				
									...
									{
										{
											...
											{
												[[_gun, _pos, _ammo, (_vh getVariable ["RydFFE_ShotsToFire",1])],acpl_arty_doartilleryfire] remoteExec ["spawn",2];
											}
										}
									...
									{
										[[_vh, _pos, _ammo, (_vh getVariable ["RydFFE_ShotsToFire",1])],acpl_arty_doartilleryfire] remoteExec ["spawn",2];
									};
