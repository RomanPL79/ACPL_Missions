...
acpl_load_actions = {
	...
	acpl_act_piss = ["acpl_piss", "Sikaj", "acpl_icons\anim.paa", {[_player] spawn acpl_piss;}, {acpl_pissing}] call ace_interact_menu_fnc_createAction;
