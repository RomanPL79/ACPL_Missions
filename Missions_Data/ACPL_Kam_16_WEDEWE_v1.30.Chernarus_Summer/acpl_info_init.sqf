...
* Wróg potrafi korzystać ze wsparcia artylerii<br/>
* Możliwość zakłócania ładunków wybuchowych (jeżeli w misji obecny jest jammer)<br/>
* Symulacje obserwatorów IED<br/>
* Ulepszone procesy myśleniowe AI<br/>
* Zwiększona ilość zacięć oraz obniżona celność w trakcie korzystania z broni przeciwnika</br>");
