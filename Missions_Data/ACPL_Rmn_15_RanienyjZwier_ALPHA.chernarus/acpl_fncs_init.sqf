...
acpl_medicalhelp_heavywounded = 1.5;					//Jak mocno musi byæ ranny aby byæ uznany za ciê¿ko rannego? (nie ruszaæ)
...
acpl_civs_firedistance = 500;						//Jak daleko od cywila musz¹ padaæ strza³y aby siê schowa³
acpl_civs_hidetime = [150,400,600];					//Na jak d³ugo cywil siê schowa?
acpl_civs_locationradius = 500;						//W jakiej odleg³oœci od centrum najbli¿szej lokacji mog¹ przebywaæ cywile?
acpl_civs_stayinhome = 50;							//Szansa w %, ¿e cywil bêdzie ca³y czas w budynku
acpl_civs_stayinhome_sleep = [60,300,600];			//Czas pomiêdzy zmian¹ pozycji w budynku dla cywila
acpl_civs_wait = [60,150,300];						//Czas pomiêdzy zmian¹ pozycji przez cywila
acpl_civs_changecity = 10;							//Szansa w %, ¿e cywil bêdzie porusza³ siê pomiêdzy miastami
acpl_civs_shootingtime = 150;						//Na jak d³ugo cywilê zapamiêtuj¹ miejsce w którym strzelano i go unikaj¹?
acpl_civs_shootingdanger = 100;						//Jak daleko od miejsca w którym strzelano jest bezpiecznie?
...
acpl_weather_changetime = [20, 40];				//Zakres czasu w minutach co ile zmieniana jest pogoda
acpl_weather_overcast = [0.4, 0.7];				//Zakres zachmurzenia
acpl_weather_rain = [0.2, 0.8];					//Zakres opadów
...
acpl_weather_enabled = true;					//Czy w³¹czyæ zmiany pogodowe?
...
acpl_msc_east_spot = [0.3, 0.6];				//Dystans wykrywania
...
private ["_acpl_civilians", "_acpl_hit_react", "_acpl_events", "_acpl_animations_functions", "_acpl_checking_functions", "_acpl_spawning_functions", "_acpl_medical_functions", "_acpl_arty_functions", "_acpl_AI_funcs", "_acpl_medicalAI_funcs"];
...
_acpl_civilians = compile preprocessFileLineNumbers "acpl_fncs_toload\civilian.sqf";
[] call _acpl_civilians;
...
private ["_acpl_config_buildings_pos", "_acpl_config_civilian"];
...
_acpl_config_civilian = compile preprocessFileLineNumbers "acpl_configs\civilian.sqf";
[] call _acpl_config_civilian;
